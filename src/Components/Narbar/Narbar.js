...
export const NavBar = () => {
  ...
  <Container>
    <Navbar.Brand href=""><img id="menu" alt="" class="logo" src="https://w7.pngwing.com/pngs/568/379/png-transparent-technology-computer-icons-technology-electronics-text-logo.png"></img></Navbar.Brand>
